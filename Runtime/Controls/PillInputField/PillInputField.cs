...
{
    /// <summary>
    /// A pill-shaped input field with a label, placeholder text. Supports optional password masking and multiline input.
    /// </summary>
    [UxmlElement]
    public partial class PillInputField : VisualElement
    {
