...
namespace UnityUIToolkit.Extensions
{
    ...
    /// </summary>
    [UxmlElement]
    public partial class CircularImageButton : VisualElement
    {
        ...
        {
            get => imageContainer.style.backgroundImage.value.texture;
            set => SetImage(value);
        }

        [UxmlAttribute("upload-label")]
        public string UploadLabel
        {
            get => uploadNewImageLabel.text;
            set => SetUploadLabel(value);
        }

        [UxmlAttribute("image-tint")]
        public Color ImageTint
        {
            get => imageContainer.style.unityBackgroundImageTintColor.value;
            set => SetImageTint(value);
        }
